...
namespace WolfPortfolio\Core;

defined( 'ABSPATH' ) || exit;

class Updater {

	const INFO_URL = 'https://downloads.wolfthemes.cloud/plugins/wolf-portfolio/info.json';
	const SLUG     = 'wolf-portfolio';
	const FILE     = 'wolf-portfolio/wolf-portfolio.php';

	public function __construct() {
		// Priority 20 so this wins over the legacy GitHub updater during the 1.3.0 transition.
	...
	private function get_remote_info() {
		$transient_key = 'wfolio_remote_info';
